...
import type {FlavorSegment} from '../types/FlavorSegment-type';

type Props = {
  data: Array<Array<FlavorSegment>>;
  showPlaceholder: boolean;
};

export default function FlavorSegmentTrend(props: Props) {
  ...
  return (
    <View style={styles.root}>
      <Text style={styles.title}>Flavor Segment Trend</Text>
      {showPlaceholder ? (
